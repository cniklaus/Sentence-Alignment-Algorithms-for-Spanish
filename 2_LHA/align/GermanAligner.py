...
class GermanAligner():
    ...
    def __init__(self, src, tgt, src_sents, tgt_sents, src_index, tgt_index, refine, lower_th, global_pairs, \
        ...
        self.load_in_memory = True #load_in_memory
        self.debug = debug
        ...
        self.src_total = 1#wc(self.src)
        self.tgt_total = 1#wc(self.tgt)
        ...
        dataset_name = "Newsela01test" #self.src.split("/")[-2]
        ...
        aligned_sentences_fname = "{}/{}/{}".format(self.dir_path, dataset_name, src_name)
        ...
        self.aligned_sentences_file = open(aligned_sentences_fname, "w")
    ...
    def write_output_lines(self, prediction, src_output=None, tgt_output=None,
        ...
        for (src_sent, tgt_sent), sim, (src_doc_id, tgt_doc_id) \
            ...
            self.aligned_sentences_file.write(src_sent + "\t" + tgt_sent + "\t" + str(sim) + "\n")
            print(src_sent + "\t" + tgt_sent + "\t" + str(sim) + "\n")
